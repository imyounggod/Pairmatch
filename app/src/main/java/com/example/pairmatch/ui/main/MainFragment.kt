    ...
    private fun initListeners() {
        binding?.run {
            ...
            vm.selectedTeam.observe(viewLifecycleOwner) { data ->
                ...
                tvSelectedDate.text = data.scheduleMatch
                ivSmallPlayerPhoto1.setImageResource(
                    data.member1?.photo ?: R.drawable.ic_plus_placeholder
                )
                ivSmallPlayerPhoto2.setImageResource(
                    data.member2?.photo ?: R.drawable.ic_plus_placeholder
                )
                ivSmallPlayerPhoto3.setImageResource(
                    data.member3?.photo ?: R.drawable.ic_plus_placeholder
                )
                ivSmallPlayerPhoto4.setImageResource(
                    data.member4?.photo ?: R.drawable.ic_plus_placeholder
                )
                ivSmallPlayerPhoto5.setImageResource(
                    data.member5?.photo ?: R.drawable.ic_plus_placeholder
                )
            ...
            tvSelectedDate.setOnClickListener {
                ...
                mdp.addOnPositiveButtonClickListener {
                    ...
                    vm.selectedTeam.value?.scheduleMatch = "${format.format(date1)} - ${format.format(date2)}"
            ...
            btnLowOefficient.setOnClickListener {
                ...
                if (vm.selectedTeam.value?.member1 == null || vm.selectedTeam.value?.member2 == null || vm.selectedTeam.value?.member3 == null || vm.selectedTeam.value?.member4 == null || vm.selectedTeam.value?.member5 == null) {
                    return@setOnClickListener
                }
